...
outputDFA target n func_nm dfa
  ...
  where    
    ...
    do_array hex_chars nm upper_bound ints = trace ("do_array: " ++ nm) $ case target of
      GhcTarget ->
	  str nm . str " :: AlexAddr\n"
	. str nm . str " = AlexA# \""
	. str (hex_chars ints)
...
genTables n_states max_token entries = trace ("genTables") $ do
